    ...
    return (
        <div className="menu-bar topheader" style={{ backgroundImage: `url(${require("../../assets/menu-clouds.svg")})` }}>
            <div className="menu-bar-panel menu-bar-panel-left">
                <div data-delay-show='100' data-offset="{'top': 6, 'left': -10}" data-place="bottom" data-effect="solid" data-tip="Go back" className="site-title">
                    <Link to="/dashboard">
                        <img className="logo" src={require("../../assets/menu/ealogo.svg")} alt="logo" />
                    </Link>
                </div>
                <ReactTooltip globalEventOff="click" eventOff="click" delayShow={100} delayUpdate={100} place="bottom" />
            ...
            <div className="menu-bar-panel menu-bar-panel-center" data-delay-show='100' data-effect="solid" data-tip="Change Project Name">
                {isEditingTitle ?
            ...
            <div className="menu-bar-panel menu-bar-panel-right">
                ...
                <div className="menu-bar-user-profile-picture">
                    <img data-place="bottom" data-multiline={true} data-delay-show='100' data-effect="solid" data-tip="Your <br/> Profile" alt={store.currentUser.displayName} src={store.currentUser.photoURL} onClick={(e) => { setShowMenu(!showMenu); e.stopPropagation(); }} ref={buttonRef} />
