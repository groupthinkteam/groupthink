...
const TailArrow = (props) => {
    ...
    const leftSVG = (
        <svg id={"tail".concat(props.id)}
            x={linePathDragging ? linePathDragging.x - 8 : tail.x - 27}
            y={linePathDragging ? linePathDragging.y - 20 : tail.y - 25} width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const rightSVG = (
        <svg id={"tail".concat(props.id)} x={linePathDragging ? linePathDragging.x - 8 : tail.x}
            y={linePathDragging ? linePathDragging.y - 20 : tail.y - 27} width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
