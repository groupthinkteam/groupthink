...
const TailArrow = (props) => {
    ...
    return (
        ...
        <svg style={{ zIndex: -1, position: "absolute", overflow: "visible" }}>
            <svg x={linePathDragging ? linePathDragging.x - 8 : tail.x - 8} id={"tail".concat(props.id)} y={linePathDragging ? linePathDragging.y - 20 : tail.y - 20} width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                {
                    !linePathDragging ?
