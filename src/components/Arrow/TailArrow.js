...
const TailArrow = (props) => {
    ...
    const bottomSVG = (
        <svg
            x={tail.x - 8}
            id={"tail".concat(props.id)} y={tail.y - 20} width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const leftSVG = (
        <svg id={"tail".concat(props.id)}
            x={tail.x - 27}
            y={tail.y - 25} width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const rightSVG = (
        <svg id={"tail".concat(props.id)} x={tail.x}
            y={tail.y - 27} width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const topSVG = (
        <svg id={"tail".concat(props.id)} x={tail.x}
            y={tail.y - 27} width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
